...
public class User {
    ...
    Map nicknames = new HashMap<String,String>(); //TODO this is bad because it's stored in a Blob, perhaps break it out into it's own entity to get some db transparency
